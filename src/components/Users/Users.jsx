        ...
        props.setUsers([
            {
                ...
                followed: false, fullName: 'Pablo Escobar', status: 'Everything in this life has a solution, except death.', location: { city: 'New York', country: 'USA' }
            },
            {
        ...
        <span className={classes.users}>Users:</span>
        {
            props.users.map(u => <div className={classes.wrapper} key={u.id}>
                <div className={classes.wrapper__avatar}>
                    <div>
                        <img className={classes.avatar} src={u.photoUrl} />
                    </div>
                ...
                <div className={classes.wrapper__info}>
                    <div>
                        <div className={classes.nickName}>{u.fullName}</div>
